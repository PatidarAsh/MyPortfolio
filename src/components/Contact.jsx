...
function Contact() {
  return (
    <div name='contact' id='contact' className='w-full flex justify-center items-center bg-black '>
        <form method='POST' action="https://getform.io/f/9c450100-9c22-46dd-bd5e-bef1a082eac4" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-white py-4'>// Submit the form below or shoot me an email - patidar.as@northeastern.edu</p>
            </div>
